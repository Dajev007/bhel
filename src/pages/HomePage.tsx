...
function ServicesOverview() {
  ...
  const services = [
    ...
    { image: '/img/Bush-Bearing-Installation-New.png', title: 'Bush & Bearing Installation', desc: 'Accurate on-site installation with acoustic alignment for longer-lasting machinery performance.', features: ['Precision installation', 'Acoustic alignment', 'Extended equipment life'], id: 'bush-bearing' },
